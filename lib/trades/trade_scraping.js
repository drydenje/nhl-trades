...
var _nhlTradeTracker = require("./nhl-trade-tracker.js");
...
const cleanData = () => {
  const arr = JSON.parse((0, _utils.readFile)(`./public/scraped-data/trades.json`));
  ...
  (0, _utils.writeFile)(`./public/scraped-data/trades.json`, arr);
};
