...
var _hrIdScraping = require("./player-data/hr-id-scraping.js");
var _hockeyDbIdScraper = require("./player-data/hockey-db-id-scraper.js");
...
=======
  ...
  let driver;
  let session;
>>>>>>> 1224a4f1f39f241dfaebd2f8569570b22d6d67f0
  try {
...
=======
>>>>>>> parent of 1224a4f (neo4j connection made, reading up on it)
// console.log(latinize("Paul Gagné"));

// missing hr: 633, hdb: 1204
// 512, 910

const p = (0, _utils.combineSiteIds)("./src/player-data/nhl-id-scraping-unique.json", "./src/player-data/results/hdb-player-ids.json", "./src/player-data/results/hr-player-id.json");
...
(0, _utils.writeFile)("./src/player-data/results/hr-missing.json", missingHR);
console.log("Missing HDB:", missingHDB.length);
(0, _utils.writeFile)("./src/player-data/results/hdb-missing.json", missingHDB);
