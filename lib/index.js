...
var _hrIdScraping = require("./hr-id-scraping.js");
var _fs = _interopRequireDefault(require("fs"));
var _playerNhlId = require("./player-data/player-nhl-id.js");
var _nhlIdScraping = require("./nhl-id-scraping.js");
...
/////////////////////////////////////////////
const teams = JSON.parse((0, _utils.readFile)(`./src/player-data/nhl-id-scraping.json`)
...
const allPlayers = teams.map(team => {
...
const uniquePlayerList = allPlayers.filter((obj1, i, arr) => arr.findIndex(obj2 => obj2.id === obj1.id) === i);
(0, _utils.writeFile)(`./src/player-data/nhl-id-scraping-unique.json`, uniquePlayerList);
