...
var _hockeyDbIdScraper = require("./utils/hockey-db-id-scraper.js");
var _res = _interopRequireDefault(require("./res.js"));
...
const addHdbID = async () => {
  ...
  const newJSON = (0, _hockeyDbIdScraper.addHdbIDToAll)(players, _res.default);
  _fs.default.writeFileSync(`./public/scraped-data/duplicate-ids-copy2.json`, JSON.stringify(newJSON), (err, data) => {
    if (err) throw err;
