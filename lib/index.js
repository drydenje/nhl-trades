...
const headings = ["id", "name", "abbreviation", "nicknames", "colors", "logo", "goalHorn", "goalHornSong", "isActive", "start", "end"];
...
_fs.default.writeFile("./src/player-data/nhl-team-ids.csv", csv, err => {
  if (err) {
    console.log(err);
  }
});
